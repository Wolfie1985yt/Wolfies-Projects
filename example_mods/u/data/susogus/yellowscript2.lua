...
idleoffsets = {'-45', '-150'} -- I recommend you have your idle offset at 0
leftoffsets = {'-28', '-210'}
downoffsets = {'-57', '-204'}
upoffsets = {'-7', '-171'}
rightoffsets = {'0', '-173'}
...
idle_xml_name = 'yellow idle'
left_xml_name = 'yellow left'
down_xml_name = 'yellow down'
up_xml_name = 'yellow up'
right_xml_name = 'yellow right'
...
name_of_character_xml = 'yellow'
name_of_character = 'yellow2'
name_of_notetype = 'yellow'
