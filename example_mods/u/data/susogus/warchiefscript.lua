...
idleoffsets = {'-30', '-91'} -- I recommend you have your idle offset at 0
leftoffsets = {'-34', '-106'}
downoffsets = {'-101', '-131'}
upoffsets = {'-64', '-106'}
rightoffsets = {'-112', '-106'}
...
name_of_character_xml = 'warchief'
name_of_character = 'warchief'
name_of_notetype = 'warchief'
