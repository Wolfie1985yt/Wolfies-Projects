...
idleoffsets = {'-85', '-220'} -- I recommend you have your idle offset at 0
leftoffsets = {'-11', '-204'}
downoffsets = {'-210', '-271'}
upoffsets = {'-85', '-190'}
rightoffsets = {'-241', '-219'}
...
name_of_character_xml = 'white'
name_of_character = 'white2'
name_of_notetype = 'white'
