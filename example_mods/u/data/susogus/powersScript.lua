...
idleoffsets = {'138', '-40'} -- I recommend you have your idle offset at 0
leftoffsets = {'137', '-57'}
downoffsets = {'89', '-67'}
upoffsets = {'112', '17'}
rightoffsets = {'100', '-41'}
...
name_of_character_xml = 'powers'
name_of_character = 'powers'
name_of_notetype = 'powers'
