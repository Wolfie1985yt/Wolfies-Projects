...
idleoffsets = {'-30', '-90'} -- I recommend you have your idle offset at 0
leftoffsets = {'214', '-105'}
downoffsets = {'-80', '-151'}
upoffsets = {'-91', '-39'}
rightoffsets = {'-39', '-30'}
...
idle_xml_name = 'Ellie Idle'
left_xml_name = 'Ellie Left'
down_xml_name = 'Ellie Down'
up_xml_name = 'Ellie Up'
right_xml_name = 'Ellie Right'
...
name_of_character_xml = 'Ellie_Assets'
name_of_character = 'ellie'
name_of_notetype = 'ellie'
name_of_notetype2 = 'all2' -- for multiple characters singing at the same time
