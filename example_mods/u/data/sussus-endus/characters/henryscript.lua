...
idleoffsets = {'-30', '10'} -- I recommend you have your idle offset at 0
leftoffsets = {'149', '-22'}
downoffsets = {'137', '-150'}
upoffsets = {'19', '2'}
rightoffsets = {'14', '-64'}
...
idle_xml_name = 'Henry Idle'
left_xml_name = 'Henry Left'
down_xml_name = 'Henry Down'
up_xml_name = 'Henry Up'
right_xml_name = 'Henry Right'
...
name_of_character_xml = 'HENRY_ASSS'
name_of_character = 'henry'
