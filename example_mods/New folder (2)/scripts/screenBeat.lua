...
function onStepHit()
    ...
    if songName == 'digitalized' then
        if curStep == 129 or curStep == 1411 then
            BeatPorcent = 1
        end
        if curStep == 644 or curStep == 1923 then
            BeatPorcent = 2
        end		
	end
    ...
    if songName == 'my-horizon-encore' then
        if curStep == 1 or curStep == 394 or curStep == 1222 or curstep == 2030 then
            BeatPorcent = 2
		end
        if curStep == 138 then
            BeatPorcent = 1
        ...
        if curStep == 906 or curStep == 1186 or curStep == 1342 or curStep == 1472 or curstep == 1990 then
            BeatPorcent = 0
        end
        if curStep == 1062 or curStep == 1286 or curStep == 1350 or curStep == 1478 or curStep == 1735 or curStep == 2286 then
            BeatPorcent = 1
        end
	end
end