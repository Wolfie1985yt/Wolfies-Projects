function onEvent(n,v1,v2)
	if n == "TweenSpin2" then
		...
		-- player notespin
		noteTweenAngle('W',8 , 360 , 0.25, quintOut)
		noteTweenAngle('X',9 , 360 , 0.25, quintOut)
		noteTweenAngle('Y',10, 360 , 0.25, quintOut)
		noteTweenAngle('Z',11, 360 , 0.25, quintOut)
...
function onTimerCompleted(tag, loops, loopsLeft)
    if tag == 'tweenstop' then
		...
		-- player notespin
		noteTweenAngle('W',8 , 0 , 0.01, linear)
		noteTweenAngle('X',9 , 0 , 0.01, linear)
		noteTweenAngle('Y',10, 0 , 0.01, linear)
		noteTweenAngle('Z',11, 0 , 0.01, linear)
