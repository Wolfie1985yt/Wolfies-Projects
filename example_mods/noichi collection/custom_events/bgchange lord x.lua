function onEvent(name, value1, value2)
	if name == 'bgchange lord x' then
   		...
   		addLuaSprite('cyclesSky')
        	...
        	setProperty('BlackvignetteCycles.visible', true)

		setProperty('defaultCamZoom', '0.95')

        	triggerEvent('Change Character', 'bf', 'bf-encoreX')
        	triggerEvent('Change Character', 'dad', 'lordx-encore')
