function onEvent(name, value1, value2)
	if name == 'bgchange sonicEXE' then
		...
		setProperty('defaultCamZoom', '0.65')
        	...
        	triggerEvent('Change Character', 'bf', 'bf-encoreEXE')
        	triggerEvent('Change Character', 'dad', 'sonicexe')

	end
end
function onStepHit()
	if curStep == 12926 then --12655
		addLuaScript('data/scripts/cam')
	end
end