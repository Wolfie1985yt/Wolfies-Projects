...
function onBeatHit()
    if curBeat > 79.5 and beatFlag < 1 then
		beatFlag = 1
	...
	if curBeat > 207 and beatFlag < 2 then
		beatFlag = 2
    ...
    if curBeat > 271 and beatFlag < 3 then
		beatFlag = 3
		
        doTweenY("mty", "mt", -250, 0.7, "quartOut")
    end

    if curBeat > 272 and beatFlag < 4 then
		beatFlag = 4
    ...
    if curBeat > 336 and beatFlag < 5 then
		beatFlag = 5
		
        doTweenX("camTween", "camFollow", 300, 0.5, "circOut")
    end

    if curBeat > 337 and beatFlag < 6 then
		beatFlag = 6
    ...
    if curBeat > 339 and beatFlag < 7 then
		beatFlag = 7
    ...
    if curBeat > 344 and beatFlag < 8 then
		beatFlag = 8
    ...
    if curBeat > 402 and beatFlag < 9 then
		beatFlag = 9
		
        doTweenY("camer", "camFollow", 0, 0.5, "circInOut")
    end

    if curBeat > 403 and beatFlag < 10 then
		beatFlag = 10
	...
	if curBeat > 533 and beatFlag < 11 then
		beatFlag = 11
...
function onStepHit()
	...
	if curStep > 299 and stepFlag < 1 then
		stepFlag = 1
		
		playSound('dxfuckingdies', 1)
	end
	
	if curStep > 311 and stepFlag < 2 and beatFlag < 6 then
		stepFlag = 2
	...
	if curStep > 1344 and stepFlag < 3 and beatFlag < 6 then
		stepFlag = 3
		
        setProperty("boyfriendGroup.visible", false)
    end  
	
	if curStep == 2048 or curStep == 2051 or curStep == 2054 then
	...
	if curStep > 2063 and stepFlag < 4 then
		stepFlag = 4
