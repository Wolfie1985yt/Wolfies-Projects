...
idleoffsets = {'-60', '-80'} -- I recommend you have your idle offset at 0
leftoffsets = {'110', '-63'}
downoffsets = {'20', '-160'}
upoffsets = {'34', '31'}
rightoffsets = {'-90', '-16'}
...
idle_xml_name = 'SONICmoveIDLE'
left_xml_name = 'SONICmoveLEFT'
down_xml_name = 'SONICmoveDOWN'
up_xml_name = 'SONICmoveUP'
right_xml_name = 'SONICmoveRIGHT'
...
name_of_character_xml = 'sonicexe'
name_of_character = 'sonicexe2'
name_of_notetype = 'sonicexe'
...
function onStepHit()
	if curStep == 6336 then
		addLuaSprite('sonicexe2',true)
	end
	if curStep == 6480 then
		removeLuaSprite('sonicexe2')
	end
	if curStep == 6481 then
		close()
	end
end