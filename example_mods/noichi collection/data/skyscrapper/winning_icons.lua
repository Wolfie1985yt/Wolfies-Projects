...
function onCreate()
	makeLuaSprite('winningIcon', 'icons/winning-icons/win-'..getProperty('boyfriend.healthicon'), getProperty('iconP1.x'), getProperty('iconP1.y'))
	...
	makeLuaSprite('winningIconDad', 'icons/winning-icons/win-'..getProperty('boyfriend.healthicon'), getProperty('iconP2.x'), getProperty('iconP2.y'))
...
function onUpdate(elapsed)
		...
		--then --uncomment if using WHITELIST or BLACKLIST
			makeLuaSprite('winningIcon', 'icons/winning-icons/win-'..getProperty('iconP1.animation.curAnim.name'), getProperty('iconP1.x'), getProperty('iconP1.y'))
			setObjectCamera('winningIcon', 'hud')
			addLuaSprite('winningIcon', true)
			setObjectOrder('winningIcon', getObjectOrder('iconP1') + 1)
			setProperty('winningIcon.flipX', true)
		...
		--then --uncomment if using WHITELIST or BLACKLIST
			makeLuaSprite('winningIconDad', 'icons/winning-icons/win-'..getProperty('iconP2.animation.curAnim.name'), getProperty('iconP2.x'), getProperty('iconP2.y'))
			setObjectCamera('winningIconDad', 'hud')
			addLuaSprite('winningIconDad', true)
			setObjectOrder('winningIconDad', getObjectOrder('iconP2') + 1)
			setProperty('winningIconDad.flipX', false)
