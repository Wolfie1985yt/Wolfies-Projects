...
function goodNoteHit(id, direction, noteType, isSustainNote)
	...
	if getPropertyFromGroup('notes', id, 'gfNote') or getPropertyFromGroup('notes', id, 'duet') or getPropertyFromGroup('notes', id, 'duetBF') or getPropertyFromGroup('notes', id, 'all') then
		if not isSustainNote then
