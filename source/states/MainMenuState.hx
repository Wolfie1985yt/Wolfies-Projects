...
class MainMenuState extends MusicBeatState
{
	...
	public static var wolfieEngineVersion:String = '0.1.0'; // This is also used for Discord RPC
	...
	override function create()
	{
		...
		var engineVer:FlxText = new FlxText(12, FlxG.height - 64, 0, "Wolfie's Engine v" + wolfieEngineVersion, 12);
