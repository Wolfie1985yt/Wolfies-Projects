...
class FlxSprite extends FlxObject
{
	...
	public function setDropColors(color:FlxColor, angle:Float, brightness:Float, hue:Float, contrast:Float, saturation:Float, blend:Bool, ?threshold:Float, ?distance:Int) {
		/*
			How to use
