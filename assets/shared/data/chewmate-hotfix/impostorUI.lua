...
function onUpdate(elapsed)
	...
	if ratingFC == 'FC' or ratingFC == 'GFC' or ratingFC == 'SFC' then
		setTextString('scoreTxt', 'Score: '..score.. ' | Combo Breaks: '..misses.. ' | Accuracy: '..round((getProperty('ratingPercent') * 100), 2) ..'% ['..ratingFC..']')
	else
		setTextString('scoreTxt', 'Score: '..score.. ' | Combo Breaks: '..misses.. ' | Accuracy: '..round((getProperty('ratingPercent') * 100), 2) ..'%')
	end
end
